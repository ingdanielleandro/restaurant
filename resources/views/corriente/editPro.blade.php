            ...
            <div class="card shadow-sm mb-3 bg-white rounded" style="max-width: 550px;">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('proteina.update',$proteina->id)}}" method="POST">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Nombre de la proteina" value="{{old('nombre',$proteina->name)}}" required>
                        ...
                        <div class="d-flex justify-content-around pt-2 mt-4">
                            <a href="{{ route('proteina.create')}}" class="btn btn-outline-warning block-center">Cancelar</a>
