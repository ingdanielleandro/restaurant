            ...
            <div class="card shadow-sm mb-3 bg-white rounded">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sopa.update', $sopa->id)}}" method="POST">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Nombre de la proteina" value="{{old('nombre',$sopa->name)}}">
